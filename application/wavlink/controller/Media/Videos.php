...
class Videos extends BaseAdmin
{
    public function lists()
    {
        if ($this->request->isGet()) {
            $path = input('get.path', 'videos/', 'htmlspecialchars,trim');
    ...
    public function createFolder()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $key = input('get.path', 'videos/', 'htmlspecialchars,trim') . $post['folder'];
    ...
    public function upload()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $key = input('get.path', 'videos/', 'htmlspecialchars,trim') . $file->getInfo('name');
