...
return array(
    ...
    'first_name'       =>  '请输入您的姓氏',
    'first_name_long'  => '姓氏不合法',
    'last_name'        => '请输入您的称呼',
    'last_name_long'   => '称呼不合法',
    'email'            => '请输入您的邮箱地址',
    'email_error'      => '邮箱格式错误',
    'description'      => '请描述您的问题',
    'description_error'=> '描述太长或者太短了',
...
//    'purchasing_link' => 'Purchasing link is error',
    ...
    //Ticket返回成功的英文提示
    'ticket_success'  => '提交成功，我们将给您回复，您将可以在您的邮箱看到我们给您的回复',
    'ticket_error'    => '您已经提交了，请勿重复提交。我们很快将回复您。',
