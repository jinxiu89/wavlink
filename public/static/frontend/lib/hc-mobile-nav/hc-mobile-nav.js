...
!function (y, e) {
    ...
    var a, l, x = e.document,
        ...
        O = function (e) {
            ...
            var l = a.children("li"), o = l.length,
    ...
    y.fn.extend({
        hcMobileNav: function (e) {
            ...
            var l, m = y.extend({}, {
                ...
                labelClose: "CLOSE",
                labelBack: "BACK"
            }, e), k = y(x.getElementsByTagName("html")[0]), b = (y(x), y(x.body)), C = (l = function (e) {
                var n = ["Webkit", "Moz", "Ms", "O"], a = (x.body || x.documentElement).style,
            ...
            return this.each(function () {
                var e = y(this), n = void 0, a = !1, l = 0;
                if (e.is("ul")) n = e.clone().wrap("<nav></nav>").parent(); else if (e.is("nav")) n = e.clone(); else if (!(n = e.find("nav, ul").first().clone()).length) return void console.log("%c! HC MobileNav:%c There is no <nav> or <ul> elements in your menu.</ul></nav>", "color: red", "color: black");
                var o = n.find("ul");
                if (o.length) {
                    var p = {}, i = void 0, v = "hc-nav-" + ++S;
                    ...
                    var r = n.children("ul").wrapAll('<div class="nav-wrapper nav-wrapper-1"></div>').parent().on("click", B).wrap('<div class="nav-container"></div>').parent();
                    ...
                    o.each(function () {
                        var e = y(this), n = e.parents("li").length;
                        if (0 !== n) {
                            ...
                            var t = y('<span class="nav-next"></span>').appendTo(l),
                    ...
                    var c = function (e, n) {
                        if (p[e] && p[e][n]) {
                            var a = p[e][n].checkbox, l = a.parent("li"), o = p[e][n].wrapper;
                            a.prop("checked", !1), o.removeClass("sub-level-open"), l.removeClass("level-open")
                        }
                    }
                } else console.log("%c! HC MobileNav:%c Menu must contain <ul> element.</ul>", "color: red", "color: black");

                function d() {
                    var e, n, a, l, o = y(this), i = Number(o.attr("data-level")), t = Number(o.attr("data-index"));
